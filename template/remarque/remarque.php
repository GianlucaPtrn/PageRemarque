    ...
    <div class="rmSearchContent">
        ...
        <div class="rmHeader2">
            <?php if($_SESSION['role'] == "secretary"): ?>
                ...
                <a class="btnNewremarque" href="index.php?/templates/remarque/newRemarque">Ajouter une nouvelle remarque</a>
            <?php endif; ?>
    ...
    <div class="rmResultContent">
        <div class="rmCase">
            ...
            <div class="rmCaseSecond">
                ...
                <p class="rmCaseProf">Mr De Mahieu</p>
                <!-- Si secrétaire, il a le bouton modifié -->
                <?php if($_SESSION['role'] == "secretary") : ?>
                    <a class="rmBtnModifier" href="index.php?/templates/remarque/modifRemarque">Modifier</a>
                    <a class="rmBtnDelete">Supprimer</a>
                <?php endif; ?>
            </div>
        </div>
